...
DynamoBackup.prototype.backupTable = function (tableName, backupPath, callback) {
    ...
    if (self.useAwsCreds) {
        ...
        // If the user chose not use AWS Creds, take the temporal from the ENV
        params.accessKey = process.env.AWS_ACCESS_KEY_ID;
        params.secretKey = process.env.AWS_SECRET_ACCESS_KEY;
    }
